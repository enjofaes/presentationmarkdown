...
author: Enjo Faes, based on the slides of Dr. Alison Hill
date: "`r Sys.Date()`"
output:
...
# Go here and install R Studio:

[Link-Software-Center](softwarecenter:SoftwareID=ScopeId_EB6FCD15-6879-4D65-8DFF-118B0F3C9097/Application_8b591d82-2f8a-4f00-adec-12d3546a0da7)
...
1. Wizardry for some. (`r emo::ji("wizard")` `r emo::ji("wink")`)
...
We are not here today to solve science reproducibility crisis.
...
_"**Y**AML **A**in't **M**arkup **L**anguage"_
...
# Do the introductory training for Markdown! `r emo::ji("point_down")`
...
`r "ctrl + alt + i "` gives the possibility to code between your text. The output of this chunck is: 
